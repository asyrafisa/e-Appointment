...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-2 col-md-offset-1 col-sm-12 col-xs-12 bodyContent">
            ...
            <ul class="headerUL">
                <li><a href="login.jsp" onClick="login();" class="bodyUL"> Maintain Holiday </a><hr></li>
                <li><a href="login.jsp" onClick="login();" class="bodyUL"> Maintain Clinic Day </a><hr></li>
                <li><a href="login.jsp" onClick="login();" class="bodyUL"> Maintain Roster   </a><hr></li>
                <li><a href="login.jsp" onClick="login();" class="bodyUL"> Maintain Leave   </a><hr></li>
                <li><a href="login.jsp" onClick="login();" class="bodyUL"> Manage Appointment </a></li>
            </ul>
            <h3 class="headerTitle">Details</h3>
            <ul class="headerUL">
                <li><a href="#" class="bodyUL">About Us </a><hr></li>
                <li><a href="#" class="bodyUL">Contact Us </a><hr></li>
                <li><a href="#" class="bodyUL">Our Location </a><hr></li>
            </ul>
