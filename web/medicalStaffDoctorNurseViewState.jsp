...
//    String hfcc = dataHFCCode.get(0).get(0);
    ...
    String sqlAppointment = "SELECT lookSub.appointment_date, lookSub.start_time, lookSub.pmi_no, lookSub.patient_name, "
            ...
            + "LCASE(au.USER_NAME) AS USER_NAME, pa.discipline, pa.subdiscipline, pa.appointment_type, pb.ID_NO, pa.status "
            ...
            <div id="holiday" class="tab-pane fade">
                ...
                <div class="dropdown"  style="padding-bottom: 2%">
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1" >
                      ...
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="medicalStaffNurseViewState.jsp">State</a></li>
                    </ul>
                  </div>
...
//                                    String staffIDFromDB = dataStaffLeave.get(i).get(1);
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center>
                                                <button class="btn btn-xs btn-primary" onClick="location.href='medicalStaffNurseCancelAppointment.jsp?e27=<%=dataAppointment.get(i).get(2)%>&e48=<%=hfcCD%>&e32=<%=dataAppointment.get(i).get(0)%>'">Cancel</button>
                                            </center>
                                        </td>
                                    </tr>
                                <%
            ...
            <div id="about" class="tab-pane fade" style="padding-right: 30%; text-align: justify">
                    <h3 class="headerTitle">About Us</h3>
                    <p> Establishment of Student Clinic is to provide medical services to students. It also aims to implement healthy lifestyle among residents UTeM, 
                        to ensure the health is at a satisfactory so that students can focus fully on their studies more effectively and brilliant. It is operated by 
                        the medical and paramedical professionals to ensure the service is the best and safe.</p>

                    <p>Although Clinic Students are given the mandate to provide medical services to students, but it also provides services and medical care to the 
                        staff of UTeM who need services such as emergency care, safety emergency loan assistance and medical services (standby) for activities which require.</p>

                    <p>Health Centre operates in three branches of the main campus, Campus Technology & the City Campus.</p>
            </div>
