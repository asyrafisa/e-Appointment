...
//                                                             text:data
//                                                          }));
                                                       document.getElementById("hfc").innerHTML=data;
                                                      } 
                                                  });
...
//                                                      document.getElementById("hfc_code").innerHTML=xmlhttp.responseText;
//                                                    }
//                                                  }
//                                                  xmlhttp.open("GET","adminGetHFC.jsp?q="+str,true);
//                                                  xmlhttp.send();
                                                }
                                        </script>
...
<!--                            <form method="post" name="myform" role="form" action="updateAbsentPatient.jsp">
                            ...
                            <form method="post" name="myform" role="form" action="sendReminder.jsp">
                                <button class="btn btn-primary">Send Appointment Reminder through SMS</button>
                            </form><br>
...
try {
    ...
    if (error != null) {
    %>
    <script>alert('<%=error %>');location.href='adminAppointment.jsp';</script>
    <%
        }
} catch (Exception e) {
